...
#library(shinysky) #loading spinner
...
FAQ_Details <- list(
  ...
  h2(tags$b("What is Supplemental Lighting Capacity (PPFD capacity)?")),
  h3("The maximum amount of light that can be provided by the supplemental lighting system. This is typically provided as part of the lighting plan provided by your lighting supplier. If not available, this can be measured using a PAR sensor when there is no sunlight."),
